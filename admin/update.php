...
if (isset($_GET['id'])) {
    ...
    while ($row = $result->fetch_assoc()) {
        $update_fname = $row['stu_fname'];
        $update_lname = $row['stu_lname'];
        $update_email = $row['stu_email'];
        $update_password = $row['stu_password'];
    }
}
                                ...
                                <div class="flex_container action">
                                    ...
                                    <div class="modal2" id="modal2">
                                        <form class="modal_content" method="POST">
                                            <div class="top">
                                                <h1>Update a user.</h1>
                                                <a href="./dashboard.php" class="close2">&times;</a>
                                            </div>
                                            <div class="middle">
                                                <div class="mid_input">
                                                    <label for="u_fname">First Name:</label>
                                                    <input name="u_fname" type="text" value="<?= $update_fname ?>" />
                                                </div>
                                                <div class="mid_input">
                                                    <label for="u_lname">Last Name:</label>
                                                    <input name="u_lname" type="text" value="<?= $update_lname ?>" />
                                                </div>
                                                <div class="mid_input">
                                                    <label for="u_email">Email:</label>
                                                    <input name="u_email" type="text" value="<?= $update_email ?>" />
                                                </div>
                                                <div class="mid_input">
                                                    <label for="u_passw">Password:</label>
                                                    <input name="u_passw" type="text" value="<?= $update_password ?>" />
                                                </div>
                                            </div>
                                            <div class="bottom">
